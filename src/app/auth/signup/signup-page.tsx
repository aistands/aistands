  ...
  if (done) return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{background:'#0B1E3E'}}>
      <div className="text-center max-w-sm">
        ...
        <p className="text-sm text-slate-ai leading-relaxed">We've sent a confirmation link to <strong className="text-white">{email}</strong>. Click it to activate your account.</p>
